...
def intermediateStepCheck(filename):
    ...
    if totalSteps < 2:
        #invalid_str = '({} potentially invalid - intermediate steps not present or step seperator not formatted properly)'
        print '   ** potentially invalid - intermediate steps not present or step separator not formatted properly'
