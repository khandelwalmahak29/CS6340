...
entry:
  ...
  %0 = load i32, i32* %y, align 4, !dbg !17
  %1 = load i32, i32* %x, align 4, !dbg !18
  call void @__dbz_sanitizer__(i32 %1, i32 4, i32 13)
...
!1 = !DIFile(filename: "simple0.c", directory: "/home/cs6340/fuzzing/fuzzing/part1/test")
!2 = !{}
...
!15 = !DILocalVariable(name: "z", scope: !7, file: !1, line: 4, type: !10)
